...
#for i in .repo .git fleece gradle Docs doc test tests docs googletest third_party _obsolete mbedtls VisualStudio dotzlib; do
for i in .repo .git fleece gradle Docs doc test tests docs googletest third_party _obsolete mbedtls; do
